...
This repository contains a collection of my web development mini projects created as part of my academic coursework and self-learning. These projects demonstrate my skills in front-end and back-end web technologies.
...
## 📌 Note
PHP projects cannot run on GitHub Pages. They are included here for code demonstration and academic purposes.
